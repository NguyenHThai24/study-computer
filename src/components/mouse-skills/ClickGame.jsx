      ...
      >
        ...
        {clickCircles.map((circle) => (
          <div
            ...
            onClick={() => {
              if (!circle.isClickable) return;
              handleCircleClick(circle.id, circle.number);
            }}
          >
            {/* Hình ảnh nền */}
            <img
            ...
            {circle.number === nextTarget && (
              <div className="absolute top-1 right-1 flex h-8 w-8 animate-pulse items-center justify-center rounded-full bg-green-500">
